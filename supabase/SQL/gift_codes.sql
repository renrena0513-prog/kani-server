...
-- Remove legacy overloads so only the latest signature remains.
drop function if exists public.admin_create_gift_code(text, integer, integer, integer, boolean);
drop function if exists public.admin_create_gift_code(text, integer, integer, integer, boolean, integer);
drop function if exists public.admin_create_gift_code(text, integer, integer, integer, boolean, integer, text[]);
...
-- Remove legacy overloads so only the latest signature remains.
drop function if exists public.admin_update_gift_code(uuid, integer, integer, integer, boolean);
drop function if exists public.admin_update_gift_code(uuid, integer, integer, integer, boolean, integer);
drop function if exists public.admin_update_gift_code(uuid, integer, integer, integer, boolean, integer, text[]);
