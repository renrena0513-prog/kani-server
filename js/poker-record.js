...
const POKER_UMA = {
    ...
    9:  { 1:  9, 2:  7, 3:  4, 4:  2, 5:  0, 6: -2, 7: -4, 8: -7, 9: -9 },
    10: { 1: 10, 2:  8, 3:  5, 4:  3, 5:  1, 6: -1, 7: -3, 8: -5, 9: -8, 10: -10 },
};
// チップ付与テーブル（人数 → 順位 → チップ数）
const POKER_CHIP_TABLE = {
    4:  { 1: 120, 2:  70, 3:  30, 4:  10 },
    5:  { 1: 150, 2:  90, 3:  50, 4:  20, 5:  10 },
    6:  { 1: 180, 2: 110, 3:  70, 4:  40, 5:  20, 6:  10 },
    7:  { 1: 210, 2: 130, 3:  90, 4:  60, 5:  30, 6:  20, 7:  10 },
    8:  { 1: 240, 2: 150, 3: 110, 4:  70, 5:  50, 6:  30, 7:  20, 8:  10 },
    9:  { 1: 270, 2: 170, 3: 130, 4:  90, 5:  60, 6:  40, 7:  30, 8:  20, 9:  10 },
    10: { 1: 300, 2: 190, 3: 150, 4: 110, 5:  80, 6:  60, 7:  40, 8:  30, 9:  20, 10:  10 },
};

// マネー報酬テーブル（人数 → 順位 → 固定マネー数）
const POKER_COIN_TABLE = {
    4:  { 1: 2000, 2: 1200, 3:  600, 4:  200 },
    5:  { 1: 2400, 2: 1600, 3: 1000, 4:  600, 5:  200 },
    6:  { 1: 2800, 2: 2000, 3: 1400, 4: 1000, 5:  600, 6:  200 },
    7:  { 1: 3300, 2: 2300, 3: 1800, 4: 1400, 5: 1000, 6:  600, 7:  200 },
    8:  { 1: 3700, 2: 2700, 3: 2200, 4: 1800, 5: 1400, 6: 1000, 7:  600, 8:  200 },
    9:  { 1: 4200, 2: 3000, 3: 2600, 4: 2200, 5: 1800, 6: 1400, 7: 1000, 8:  600, 9:  200 },
    10: { 1: 4600, 2: 3400, 3: 3000, 4: 2600, 5: 2200, 6: 1800, 7: 1400, 8: 1000, 9:  600, 10:  200 },
};
